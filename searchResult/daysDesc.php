...
<html lang="ja">
    ...
    <body>
        ...
        ?>
        <!-- category "日付降順"を取得 -->
        <?php $ascDB = $PDO->query("SELECT * FROM words ORDER BY created_at DESC "); ?>
        <!-- ここまで category "日付降順"を取得 -->
        <h3 style="color:blue; width:95%; margin:0 auto; padding:10px 0; border-bottom:1px solid;">-- タイトル：日付降順 --</h3>
