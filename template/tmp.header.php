        ...
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="searchResult/HTML&CSS.php">HTML & CSS</a>
                    <a class="dropdown-item" href="searchResult/PHP.php">PHP</a>
                    <a class="dropdown-item" href="searchResult/mysql.php">MySQL</a>
                    <a class="dropdown-item" href="searchResult/bootstrap.php">bootstrap</a>
                    <a class="dropdown-item" href="searchResult/Heroku.php">Heroku</a>
                    <a class="dropdown-item" href="searchResult/other.php">その他</a>
                </div>
            </li>
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="searchResult/asc.php">昇順</a>
                    <a class="dropdown-item" href="searchResult/desc.php">降順</a>
                    <a class="dropdown-item" href="searchResult/daysAsc.php">日付昇順</a>
                    <a class="dropdown-item" href="searchResult/daysDesc.php">日付降順</a>
                </div>
            </li>
        </ul>
